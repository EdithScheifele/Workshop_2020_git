...
- create an Github account
  + fork and clone the repository with the slides for today
...
## Github: Create an Account, Fork and Clone

- create an account at Github
- navigate to: https://github.com/EdithScheifele/Workshop_2020_git
- fork it
- then go to your Github page and clone the repo by copying the https link
- go to the desktop, open a bash shell
...
- we have a Github account and we are able to start collaborating by forking and cloning a repo
